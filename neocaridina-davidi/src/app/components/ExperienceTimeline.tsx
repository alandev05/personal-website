...
const timelineItems: TimelineItem[] = [
  {
    ...
    description: [
      "Architected an autonomous, LLM-powered agent that automates end-to-end Fire Tablet Launcher performance regression investigations, replacing a multi-week manual workflow: it reproduces regressions on-device, root-causes them from Perfetto traces and cross-repo diffs, and validates fixes in a closed-loop build–measure cycle",
      "Shipped agent-diagnosed fixes to production after review, improving WarmStartFluidity from 82.43% to 90.05% and reducing WarmStart latency 55% (3,590 ms → 1,628 ms)",
    ],
  },
  {
    id: "2",
    type: "experience",
    title: "Co-Founder",
    location: "Ceed CRM, Cambridge, MA",
  ...
  },
  {
    ...
    description: [
      "Architected agentic chat workflows and a testing platform (React, Flask, MongoDB) with a 3-tier, multi-persona, modular real-time conversation engine for a consumer app serving 1.2 million+ users",
      "Built a dynamic prompt-engineering system with context-depth scaling and placeholder matching across personas",
    ],
  },
  {
    id: "4",
