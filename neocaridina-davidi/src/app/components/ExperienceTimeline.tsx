...
const timelineItems: TimelineItem[] = [
  {
    ...
    description: ["Devices, Summer 2026"],
  },
  {
    id: "2",
    type: "experience",
    title: "IDEAS",
    location: "MIT PKG Center for Social Impact",
    date: "February 2026 - Present",
    description: [],
  },
  {
    ...
    description: [
      "Building the AI native fundraising platform for nonprofits",
    ],
  },
  {
    id: "4",
    type: "experience",
    title: "MTC Startup Pass & MIT Fuse",
    location: "Martin Trust Center for MIT Entrepreneurship, Cambridge, MA",
    date: "September 2025 - Present",
    description: [
      "MTC Startup Pass - Building Ceed",
      "MIT Fuse - Certified Fuser (3 week sprint program)",
    ],
  },
  {
    id: "5",
    type: "experience",
    title: "Founder",
    location: "MIT Sandbox Innovation Fund Program, Cambridge, MA",
    date: "October 2025 - January 2026",
    description: ["Building Ceed - Fall 2025 Cohort"],
  },
  {
    id: "6",
    type: "experience",
    title: "Resident",
    location: "Dedalus Labs, San Francisco, CA",
    date: "December 2025",
    description: ["Dedalus: Break In"],
  },
  {
    id: "7",
    type: "experience",
    title: "Software Developer Intern",
    location: "Peer, Remote",
    date: "June 2025 - August 2025",
    description: ["Built and tested agentic chat workflows"],
  },
  {
    id: "8",
    type: "education",
